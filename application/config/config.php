...
|
*/
$config['base_url'] = 'http://localhost/ftvbrandlicense-revamped-version/';
// $config['base_url'] = 'https://ftvcitypartner.in/';
 ...
 * Maintenance Mode
 * -----------------------------------------------------------------------
 * Whenever the site is under construction or under development, developer must turn on the maintenance_mode to TRUE
 * default maintenance_mode is FALSE.
 * 
 * Boolean:     TRUE    FALSE
*/
