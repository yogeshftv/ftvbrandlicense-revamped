...
<body class="for--our-story">
    ...
    <main class="our-story">
        ...
        <section class="our-story-introduction--for-mobile mt-0">
            <div class="row mx-0">
                <div class="col-12 column-1 px-0">
                    <img src="<?= base_url(); ?>assets/media/images/templates/about-example-1.png" alt="about-brand-license--images" class="w-100">
                </div>
        ...
        <section class="our-story-introduction--for-desktop mt-0">
            <div class="row primary-row mx-0">
