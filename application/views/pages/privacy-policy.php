...
<body class="for-home" style="overflow-y: visible;">
    <main class="blogs privacypol-page text-white">
        <section class="section-1">
            <div class="content">
                <h1 class="cover-heading hvc-reg--ff text-uppercase text-white text-center">Privacy & Policy</h1>
            </div>
        </section>
        <!--  -->
        <div class="container">
            <h2 class="my-5 text-white">FashionTV Privacy Policy</h2>
            <p class="text-white">
                FashionTV India operates ftvlifestylebay.in. This page informs you of our
                policies regarding the collection, use, and disclosure of personal
                information we receive from users of the site. We use your Personal
                Information only for internal FTV ftvlifestylebay.in internal processes and
                improving your experience on the site. By using the site, you agree to
                the collection and use of information in accordance with this policy.
            </p>
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Introduction</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Scope</h2>
                <p class="text-white">This policy applies to all visitors to FashionTV's websites.</p>
                <p class="text-white">
                ...
                <ul>
                    <p class="text-white">
                    <p class="text-white">Screening and Selection process of the participants.</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">To recognize a unique anonymous user and enhance its user
                        experience.</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">To communicate and notify you about FashionTV's latest updates,
                        offers, events, etc.</p>
                    </p>
                </ul>
                <br /><br />
                ...
                <ul>
                    ...
                    <p class="text-white">
                    <p class="text-white">Financial information such as bank account or credit card or debit
                        card or other payment instrument details;</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">Physical, physiological, and mental health condition;</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">Sexual orientation;</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">Medical records and history;</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">Biometric information;</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">Any detail relating to the above personal information categories as
                        provided to FashionTV for providing service; and</p>
                    </p>
                    <p class="text-white">
                    <p class="text-white">Any of the information received under the above personal information
            ...
            <div>
                ...
                <ul>
                    <p>
                    <p class="text-white">To provide information or interactive services through this website,
                        to the visitor's email address or, where the visitor wishes it to be
                        sent by post, to the visitor's postal address;</p>
                    </p>
                    <p>
                    <p class="text-white">To seek the visitor's feedback or to contact the visitor in relation
                        to the services offered on the FashionTV's website;</p>
                    </p>
                    <p>
                    <p class="text-white">To process orders or applications submitted by the visitor;</p>
                    </p>
                    <p>
                    <p class="text-white">To administer or otherwise carry out FashionTV's obligations in
                        relation to any agreement that the visitor may have with FashionTV;</p>
                    </p>
                    <p>
                    <p class="text-white">To anticipate and resolve problems with any goods or services
                        supplied to the visitor;</p>
                    </p>
                    <p>
                    <p class="text-white">To create products or services that may meet the visitor's needs;</p>
                    </p>
                    <p>
                    <p class="text-white">To process and respond to requests, improve FashionTV operations,
                        and communicate with visitor/s about FashionTV products, services,
                        and businesses; and</p>
                    </p>
                    <p>
                    <p class="text-white">To allow the visitor to subscribe to FashionTV news alerts.</p>
                    </p>
                </ul>
            </div>
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Collection of Information</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Cookies Policy</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Access, Correction of Information, and withdrawal of consent</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Retention, Processing, and storage of information</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Disclosure of Information</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Security</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div>
                <h2 class="my-5 text-white">Changes to This Privacy Policy</h2>
                <p class="text-white">
            ...
            <!--  -->
            <div class="my-5">
                <h2 class="my-5 text-white">Contact Us</h2>
                <p class="text-white">
