...
<body class="for-kashiff-khan">

    <main class="kashiff-khan">
        <!-- Banner Video -->
        ...
        <section class="boards-common-introduction mt-0">
            ...
            <div class="container-fluid px-0">
                <div class="row mx-0">
                    <div class="col-md-7 px-0 column-1">
                    ...
                    <div class="col-md-5 px-0 column-2">
                        <video playsinline="" defaultmuted="" preload="auto" muted="" loop="" autoplay="" poster="https://ftvchp.in/assets/images/kk/asset4.png" class="w-100">
                            <source src="https://frn.s3.ftvassets.in/media/videos/kashiff-khan/kk-video-square.mp4" type="video/mp4" class="w-100">
                        </video>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const svgElement = document.getElementById("f-intro-kk");
            const paths = svgElement.querySelectorAll(".path-for-ftv-intro-kk");
