...
<script src="<?= base_url(); ?>assets/cdns/js/splittext.min.js"></script>

<!-- anime.js -->
<script src="<?= base_url(); ?>assets/cdns/js/anime.min.js"></script>

<!-- AOS cdn -->
<script src="<?= base_url(); ?>assets/cdns/js/aos.js"></script>

<!-- GSAP cdn -->
<script src="<?= base_url(); ?>assets/cdns/js/gsap.min.js"></script>

<!-- GSAP scrollTrigger -->
<script src="<?= base_url(); ?>assets/cdns/js/ScrollTrigger.min.js"></script>
...
<script>
    const firebaseConfig = {
        ...
        projectId: "phone-auth-f0667",
        storageBucket: "phone-auth-f0667.appspot.com",
        messagingSenderId: "730034349440",
        appId: "1:730034349440:web:b9fd705917b6f254edcd65",
        measurementId: "G-1KJJX4B7RV"
    };
